...
public record PlatformPolicy(boolean enabled, double maxWidthRatio, Map<String, Boolean> bodies,
                             Map<Identifier, Boolean> supports) {
    public static final PlatformPolicy DEFAULT = new PlatformPolicy(true, .6, Map.of(), Map.of());
    public static final Codec<PlatformPolicy> CODEC = RecordCodecBuilder.create(i -> i.group(
        ...
        PlatformDefinition.POSITIVE.optionalFieldOf("max_width_ratio", .6).forGetter(PlatformPolicy::maxWidthRatio),
