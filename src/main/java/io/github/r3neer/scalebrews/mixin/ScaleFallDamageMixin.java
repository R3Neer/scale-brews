...
public abstract class ScaleFallDamageMixin {
    ...
    private float scalebrews$reduceFallDamage(float original, DamageSource source, float damage) {
        return source.is(DamageTypeTags.IS_FALL) && (Object)this instanceof net.minecraft.world.entity.player.Player p
                ? ScalePhysics.fallDamage(original, io.github.r3neer.scalebrews.scale.ScaleSize.shrinking(p)) : original;
    }
}
