...
/** @deprecated Compatibility wrapper. Canonical behavior is owned by {@link PlayerWalkingPoseEngine}. */
@Deprecated
public final class PlayerWalkingPose implements PoseProvider, PoseEngine {
    private static final PlayerWalkingPoseEngine ENGINE = new PlayerWalkingPoseEngine();
