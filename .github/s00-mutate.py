...
CASES = {
    ...
    'bodypath-certificate': ('physics/BodyPath.java', ' || support+1e-9<bounds.minDotAntiGravity()', '',
        's00temporal_tests_body_path_rejects_an_impossible_normal_certificate'),
    'bodypath-interior-certificate': ('physics/BodyPath.java', ' || denominator+1e-9<minDot', '',
