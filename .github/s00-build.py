...
(evidence / 'identity.txt').write_text(
    ...
    + '\nrepair2_patch_sha256=' + spec.get('repair2_patch_sha256','')
    + '\nobserver_fixture_patch_sha256=' + spec.get('observer_fixture_patch_sha256','')
    + '\nrepair3_patch_sha256=' + spec.get('repair3_patch_sha256','')
    + '\nhostile_patch_sha256=' + spec.get('hostile_patch_sha256','')
    + '\nhierarchy_holdout_patch_sha256=' + spec.get('hierarchy_holdout_patch_sha256','') + '\n')
